public class Theory {
   public static void main(String[] args) {
      ...
      String epic_burger = my_hamburger.concat(" made out of silicon");
      epic_burger = epic_burger.toUpperCase();
      String whatsacpumadeof = epic_burger.substring(33);
      ...
      System.out.println(epic_burger);
      System.out.println(whatsacpumadeof);
   }
}